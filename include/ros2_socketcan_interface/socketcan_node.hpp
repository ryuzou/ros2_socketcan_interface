...
namespace socketcan_interface {
    ...
    private:
        rclcpp::Subscription<socketcan_interface::msg::SocketcanIF>::SharedPtr _subscription;
        rclcpp::TimerBase::SharedPtr _pub_timer;

        int64_t interval_ms;

        std::string can_interface_name;
        std::map<uint16_t, rclcpp::Publisher<socketcan_interface::msg::SocketcanIF>::SharedPtr> known_id_rx_publisher;
        ...
        void _subscriber_callback(socketcan_interface::msg::SocketcanIF msg);
    public:
